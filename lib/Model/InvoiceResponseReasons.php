 ...
 * @category Class
 *
 * @description Depending on the status code, a clarification may be needed to state the buyer’s reason for the status.
 ...
 * [REF] References incorrect. Indicates that the received document did not contain references as required by the receiver
 * for correctly routing the document for approval or processing.
