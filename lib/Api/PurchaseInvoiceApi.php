...
class PurchaseInvoiceApi
{
    ...
    public function deletePurchaseInvoiceRequest($party_id, $document_id)
    {
        ...
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling deletePurchaseInvoice');
        }
        ...
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $document_id when calling deletePurchaseInvoice');
        }
    ...
    public function downloadPurchaseInvoiceRequest($party_id, $document_id, $target_format = null)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling downloadPurchaseInvoice');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        // verify the required parameter 'document_id' is set
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $document_id when calling downloadPurchaseInvoice');
        }
        if (strlen($document_id) > 256) {
    ...
    public function getPurchaseInvoiceStatusesRequest($party_id, $document_id)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling getPurchaseInvoiceStatuses');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        // verify the required parameter 'document_id' is set
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $document_id when calling getPurchaseInvoiceStatuses');
        }
        if (strlen($document_id) > 256) {
    ...
    public function recognizePurchaseInvoiceRequest($party_id, $file)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling recognizePurchaseInvoice');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $file when calling recognizePurchaseInvoice');
        }
    ...
    public function sendInvoiceResponseRequest($party_id, $document_id, $invoice_response)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling sendInvoiceResponse');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        // verify the required parameter 'document_id' is set
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $document_id when calling sendInvoiceResponse');
        }
        if (strlen($document_id) > 256) {
        ...
        if ($invoice_response === null || (is_array($invoice_response) && count($invoice_response) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $invoice_response when calling sendInvoiceResponse');
        }
