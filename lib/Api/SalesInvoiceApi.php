...
class SalesInvoiceApi
{
    ...
    public function getSalesInvoiceStatusesRequest($party_id, $document_id)
    {
        ...
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling getSalesInvoiceStatuses');
        }
        ...
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $document_id when calling getSalesInvoiceStatuses');
        }
    ...
    public function queryRecipientPartyForSalesInvoiceRequest($party_id, $request_body, $preferred_document_type_id = null)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling queryRecipientPartyForSalesInvoice');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        if ($request_body === null || (is_array($request_body) && count($request_body) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request_body when calling queryRecipientPartyForSalesInvoice');
        }
    ...
    public function recognizeSalesInvoiceRequest($party_id, $file)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling recognizeSalesInvoice');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $file when calling recognizeSalesInvoice');
        }
    ...
    public function sendSalesInvoiceRequest($party_id, $file, $receiver_id = null)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling sendSalesInvoice');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $file when calling sendSalesInvoice');
        }
