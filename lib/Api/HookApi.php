...
class HookApi
{
    ...
    public function getHooksRequest($party_id)
    {
        ...
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling getHooks');
        }
    ...
    public function sendHookPingRequest($party_id)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling sendHookPing');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
    ...
    public function subscribeRequest($party_id, $hook)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling subscribe');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        if ($hook === null || (is_array($hook) && count($hook) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $hook when calling subscribe');
        }
    ...
    public function unSubscribeRequest($party_id, $hook_id)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $party_id when calling unSubscribe');
        }
        if (!preg_match('/[A-Za-z0-9-=:]+/', $party_id)) {
        ...
        if ($hook_id === null || (is_array($hook_id) && count($hook_id) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $hook_id when calling unSubscribe');
        }
